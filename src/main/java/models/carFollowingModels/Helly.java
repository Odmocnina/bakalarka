...
public class Helly implements ICarFollowingModel {
    ...
    public double getNewSpeed(HashMap<String, Double> parameters) {
        ...
        double speedDifferenceToNextCar = parameters.get(Constants.SPEED_DIFFERENCE_TO_NEXT_CAR_REQUEST);
        ...
        double acceleration = speedDifferenceSensitivityParameter * speedDifferenceToNextCar +
