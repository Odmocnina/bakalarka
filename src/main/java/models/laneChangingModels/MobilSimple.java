 ...
 * gain of the car behind in lane where the car is before changing lane. Annotated with @ModelId("mobil-simple") for
...
public class MobilSimple implements ILaneChangingModel {
    ...
    /**
     * gives the type of the MOBIL model (simple version), used for control if car foll. model type matches
     *
